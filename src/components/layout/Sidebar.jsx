...
const adminItems = [
  ...
  { name: 'Practitioner Compliance', icon: Shield, page: 'PractitionerCompliance', managerOnly: true },
  { name: 'Client Outcomes', icon: TrendingUp, page: 'ClientOutcomesTracking' },
  { name: 'AI Compliance Auditor', icon: ShieldCheck, page: 'ComplianceAuditor', managerOnly: true },
